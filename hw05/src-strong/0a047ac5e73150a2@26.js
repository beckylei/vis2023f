...
md`## Strong baseline - 利用蘋果成績圖環繞個人照片(小組)(2pt)`
)}
...
FileAttachment("simple_15_2.json").json()
)}
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["simple_15_2.json", {url: new URL("./simple_15_2.json", import.meta.url), mimeType: "application/json", toString}]
  ]);
