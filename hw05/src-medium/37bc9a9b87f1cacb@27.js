...
FileAttachment("simple_15.json").json()
)}
...
md`## Medium baseline - 點擊節點可以展開或縮放(2pt)`
)}
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["simple_15.json", {url: new URL("./simple_15.json", import.meta.url), mimeType: "application/json", toString}]
  ]);
