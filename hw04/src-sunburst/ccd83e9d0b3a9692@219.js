...
function _artist11(__query,FileAttachment,invalidation){return(
__query(FileAttachment("artist-1@1.csv"),{from:{table:"artist-1"},sort:[],slice:{to:null,from:null},filter:[],select:{columns:null}},invalidation)
)}
...
md`## 結論
### 從上圖中，我們可以看出：
- ### 工作室的藝術工作者占此問卷的多數，其次為替代空間
- ### 減碳排放行動以1.減少包裝材及文宣印製 2.使用無毒媒材、再生材料、廢物利用素材等 3.工作場所、活動展場的節約電源 這三種為主`
)}
...
export default function define(runtime, observer) {
  ...
  main.variable(observer("artist11")).define("artist11", ["__query","FileAttachment","invalidation"], _artist11);
